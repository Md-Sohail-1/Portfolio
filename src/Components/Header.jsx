    ...
    <header id="header" className="flex items-center justify-between p-4 bg-slate-200 shadow-md fixed w-full z-50 max-h-16 md:px-16 sm:px-6">
     ...
     //  Navbar 
      ...
      <nav className="hidden md:flex gap-6 text-lg">
        <a href="#about" className="hover:text-indigo-600 text-gray-600 hover:underline hover:underline-offset-8 transition">About</a>
        <a href="#projects" className="hover:text-indigo-600 text-gray-600 hover:underline hover:underline-offset-8 transition">Projects</a>
        <a href="#skills" className="hover:text-indigo-600 text-gray-600 hover:underline hover:underline-offset-8 transition">Skills</a>
        <a href="#contact" className="hover:text-indigo-600 text-gray-600 hover:underline hover:underline-offset-8 transition">Contact</a>
      </nav>
