    ...
    <section id="contact" className="pb-16 pt-6 px-6 bg-slate-700">
      <div className="max-w-4xl mx-auto text-center sm:px-6 md:px-12">
        ...
        <form id="contactForm" onSubmit={submitContactForm} className="max-w-xl mx-auto space-y-3 sm:px-6 md:px-12">
          <div>
            <input type="text" placeholder="Your Name" required  onChange={handleInputChange} value={inputData.name} name='name' className="w-full px-4 py-3 bg-slate-300 text-slate-800 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 placeholder-slate-600"/>
          </div>
          <div>
            <input type="email" placeholder="Your Email" required  onChange={handleInputChange} value={inputData.email} name='email' className="w-full px-4 py-3 bg-slate-300 text-slate-800 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 placeholder-slate-600"/>
          </div>
          <div>
